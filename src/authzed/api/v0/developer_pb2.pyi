...
class FormatSchemaResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "formatted_schema", b"formatted_schema"]) -> None: ...
...
class UpgradeSchemaRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["namespace_configs", b"namespace_configs"]) -> None: ...
...
class UpgradeSchemaResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["error", b"error"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "upgraded_schema", b"upgraded_schema"]) -> None: ...
...
class ShareRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["assertions_yaml", b"assertions_yaml", "relationships_yaml", b"relationships_yaml", "schema", b"schema", "validation_yaml", b"validation_yaml"]) -> None: ...
...
class ShareResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["share_reference", b"share_reference"]) -> None: ...
...
class LookupShareResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["assertions_yaml", b"assertions_yaml", "relationships_yaml", b"relationships_yaml", "schema", b"schema", "status", b"status", "validation_yaml", b"validation_yaml"]) -> None: ...
...
class RequestContext(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["relationships", b"relationships", "schema", b"schema"]) -> None: ...
...
class EditCheckRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["check_relationships", b"check_relationships", "context", b"context"]) -> None: ...
...
class EditCheckResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["error", b"error", "relationship", b"relationship"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "is_member", b"is_member", "relationship", b"relationship"]) -> None: ...
...
class EditCheckResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["check_results", b"check_results", "request_errors", b"request_errors"]) -> None: ...
...
class ValidateRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["context", b"context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["assertions_yaml", b"assertions_yaml", "context", b"context", "update_validation_yaml", b"update_validation_yaml", "validation_yaml", b"validation_yaml"]) -> None: ...
...
class ValidateResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["request_errors", b"request_errors", "updated_validation_yaml", b"updated_validation_yaml", "validation_errors", b"validation_errors"]) -> None: ...
...
class DeveloperError(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["column", b"column", "context", b"context", "kind", b"kind", "line", b"line", "message", b"message", "path", b"path", "source", b"source"]) -> None: ...
