...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_WATCHRESOURCESREQUEST'].fields_by_name['resource_object_type']._serialized_options = b'\372BErC(\200\0012>^([a-z][a-z0-9_]{1,61}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$\272HErC(\200\0012>^([a-z][a-z0-9_]{1,61}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$'
  _globals['_WATCHRESOURCESREQUEST'].fields_by_name['permission']._loaded_options = None
  _globals['_WATCHRESOURCESREQUEST'].fields_by_name['permission']._serialized_options = b'\372B$r\"(@2\036^[a-z][a-z0-9_]{1,62}[a-z0-9]$\272H$r\"(@2\036^[a-z][a-z0-9_]{1,62}[a-z0-9]$'
  ...
  _globals['_WATCHRESOURCESREQUEST']._serialized_start=187
  _globals['_WATCHRESOURCESREQUEST']._serialized_end=706
  _globals['_PERMISSIONUPDATE']._serialized_start=709
  _globals['_PERMISSIONUPDATE']._serialized_end=1097
  _globals['_PERMISSIONUPDATE_PERMISSIONSHIP']._serialized_start=980
  _globals['_PERMISSIONUPDATE_PERMISSIONSHIP']._serialized_end=1097
  _globals['_WATCHRESOURCESRESPONSE']._serialized_start=1100
  _globals['_WATCHRESOURCESRESPONSE']._serialized_end=1257
  _globals['_WATCHRESOURCESSERVICE']._serialized_start=1260
  _globals['_WATCHRESOURCESSERVICE']._serialized_end=1429
