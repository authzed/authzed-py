...
class CheckDebugTrace(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["resolution",b"resolution"]) -> typing.Optional[typing_extensions.Literal["was_cached_result","sub_problems"]]: ...
