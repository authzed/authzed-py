...
class _ErrorReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ErrorReason.ValueType], builtins.type):
    ...
    """
    ERROR_REASON_EXCEEDS_MAXIMUM_ALLOWABLE_LIMIT: _ErrorReason.ValueType  # 22
    ...
    """
    ERROR_REASON_INVALID_FILTER: _ErrorReason.ValueType  # 23
    ...
    """
    ERROR_REASON_INMEMORY_TOO_MANY_CONCURRENT_UPDATES: _ErrorReason.ValueType  # 24
    ...
    """
    ERROR_REASON_EMPTY_PRECONDITION: _ErrorReason.ValueType  # 25
...
"""
ERROR_REASON_EXCEEDS_MAXIMUM_ALLOWABLE_LIMIT: ErrorReason.ValueType  # 22
"""The request's specified limit is too large.
...
"""
ERROR_REASON_INVALID_FILTER: ErrorReason.ValueType  # 23
"""The request failed because the provided filter was invalid in some way.
...
"""
ERROR_REASON_INMEMORY_TOO_MANY_CONCURRENT_UPDATES: ErrorReason.ValueType  # 24
"""The request failed because too many concurrent updates were attempted
against the in-memory datastore.
...
"""
ERROR_REASON_EMPTY_PRECONDITION: ErrorReason.ValueType  # 25
"""The request failed because the precondition specified is empty.
