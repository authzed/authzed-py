...
class Consistency(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["requirement",b"requirement"]) -> typing.Optional[typing_extensions.Literal["minimize_latency","at_least_as_fresh","at_exact_snapshot","fully_consistent"]]: ...
