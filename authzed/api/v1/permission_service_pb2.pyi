...
class LookupSubjectsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"consistency",b"consistency",u"resource",b"resource"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"consistency",b"consistency",u"optional_subject_relation",b"optional_subject_relation",u"permission",b"permission",u"resource",b"resource",u"subject_object_type",b"subject_object_type"]) -> None: ...
...
class LookupSubjectsResponse(google.protobuf.message.Message):
    ...
    subject_object_id: typing.Text = ...

    @property
    def excluded_subject_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    ...
    def __init__(self,
        *,
        looked_up_at : typing.Optional[authzed.api.v1.core_pb2.ZedToken] = ...,
        subject_object_id : typing.Text = ...,
        excluded_subject_ids : typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"looked_up_at",b"looked_up_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"excluded_subject_ids",b"excluded_subject_ids",u"looked_up_at",b"looked_up_at",u"subject_object_id",b"subject_object_id"]) -> None: ...
