...
class WatchRequest(google.protobuf.message.Message):
    ...
    OBJECT_TYPES_FIELD_NUMBER: builtins.int
    OPTIONAL_START_CURSOR_FIELD_NUMBER: builtins.int

    @property
    def object_types(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    ...
    def __init__(self,
        *,
        object_types : typing.Optional[typing.Iterable[typing.Text]] = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"object_types",b"object_types",u"optional_start_cursor",b"optional_start_cursor"]) -> None: ...
