...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RELATIONSHIPFILTER.fields_by_name['resource_type']._serialized_options = b'\372BErC(\200\0012>^([a-z][a-z0-9_]{2,61}[a-z0-9]/)?[a-z][a-z0-9_]{2,62}[a-z0-9]$'
  ...
  _RELATIONSHIPFILTER.fields_by_name['optional_relation']._serialized_options = b'\372B\'r%(@2!^([a-z][a-z0-9_]{2,62}[a-z0-9])?$'
  _SUBJECTFILTER_RELATIONFILTER.fields_by_name['relation']._options = None
  _SUBJECTFILTER_RELATIONFILTER.fields_by_name['relation']._serialized_options = b'\372B\'r%(@2!^([a-z][a-z0-9_]{2,62}[a-z0-9])?$'
  _SUBJECTFILTER.fields_by_name['subject_type']._options = None
  _SUBJECTFILTER.fields_by_name['subject_type']._serialized_options = b'\372BErC(\200\0012>^([a-z][a-z0-9_]{2,61}[a-z0-9]/)?[a-z][a-z0-9_]{2,62}[a-z0-9]$'
  ...
  _CHECKPERMISSIONREQUEST.fields_by_name['permission']._serialized_options = b'\372B\'r%(@2!^([a-z][a-z0-9_]{2,62}[a-z0-9])?$'
  ...
  _EXPANDPERMISSIONTREEREQUEST.fields_by_name['permission']._serialized_options = b'\372B\'r%(@2!^([a-z][a-z0-9_]{2,62}[a-z0-9])?$'
  _LOOKUPRESOURCESREQUEST.fields_by_name['resource_object_type']._options = None
  _LOOKUPRESOURCESREQUEST.fields_by_name['resource_object_type']._serialized_options = b'\372BErC(\200\0012>^([a-z][a-z0-9_]{2,61}[a-z0-9]/)?[a-z][a-z0-9_]{2,62}[a-z0-9]$'
  _LOOKUPRESOURCESREQUEST.fields_by_name['permission']._options = None
  _LOOKUPRESOURCESREQUEST.fields_by_name['permission']._serialized_options = b'\372B$r\"(@2\036^[a-z][a-z0-9_]{2,62}[a-z0-9]$'
