...
class AllowedRelation(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["relation_or_wildcard",b"relation_or_wildcard"]) -> typing.Optional[typing_extensions.Literal["relation","public_wildcard"]]: ...
...
class UsersetRewrite(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["rewrite_operation",b"rewrite_operation"]) -> typing.Optional[typing_extensions.Literal["union","intersection","exclusion"]]: ...
...
class SetOperation(google.protobuf.message.Message):
    ...
    class Child(google.protobuf.message.Message):
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["child_type",b"child_type"]) -> typing.Optional[typing_extensions.Literal["_this","computed_userset","tuple_to_userset","userset_rewrite"]]: ...
...
class ComputedUserset(google.protobuf.message.Message):
    ...
    class _ObjectEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ComputedUserset._Object.ValueType], builtins.type):
