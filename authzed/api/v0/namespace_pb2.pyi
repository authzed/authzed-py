...
class TypeInformation(google.protobuf.message.Message):
    ...
    @property
    def allowed_direct_relations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[authzed.api.v0.core_pb2.RelationReference]: ...

    def __init__(self,
        *,
        allowed_direct_relations : typing.Optional[typing.Iterable[authzed.api.v0.core_pb2.RelationReference]] = ...,
        ) -> None: ...
