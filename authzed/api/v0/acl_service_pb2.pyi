...
from authzed.api.v0.core_pb2 import (
    ObjectAndRelation as authzed___api___v0___core_pb2___ObjectAndRelation,
    ...
    RelationTupleTreeNode as authzed___api___v0___core_pb2___RelationTupleTreeNode,
    RelationTupleUpdate as authzed___api___v0___core_pb2___RelationTupleUpdate,
    User as authzed___api___v0___core_pb2___User,
...
class RelationTupleFilter(google___protobuf___message___Message):
    ...
    @property
    def userset(self) -> authzed___api___v0___core_pb2___ObjectAndRelation: ...
    ...
    def __init__(self,
        *,
        ...
        userset : typing___Optional[authzed___api___v0___core_pb2___ObjectAndRelation] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"filters",b"filters",u"namespace",b"namespace",u"object_id",b"object_id",u"relation",b"relation",u"userset",b"userset"]) -> None: ...
...
class WriteRequest(google___protobuf___message___Message):
    ...
    @property
    def write_conditions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[authzed___api___v0___core_pb2___RelationTuple]: ...
    ...
    def __init__(self,
        *,
        write_conditions : typing___Optional[typing___Iterable[authzed___api___v0___core_pb2___RelationTuple]] = None,
...
class CheckRequest(google___protobuf___message___Message):
    ...
    @property
    def test_userset(self) -> authzed___api___v0___core_pb2___ObjectAndRelation: ...

    @property
    def user(self) -> authzed___api___v0___core_pb2___User: ...
    ...
    def __init__(self,
        *,
        test_userset : typing___Optional[authzed___api___v0___core_pb2___ObjectAndRelation] = None,
        user : typing___Optional[authzed___api___v0___core_pb2___User] = None,
        at_revision : typing___Optional[authzed___api___v0___core_pb2___Zookie] = None,
        ) -> None: ...
...
class CheckResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    MembershipValue = typing___NewType('MembershipValue', builtin___int)
    type___MembershipValue = MembershipValue
    Membership: _Membership
    class _Membership(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[CheckResponse.MembershipValue]):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        UNKNOWN = typing___cast(CheckResponse.MembershipValue, 0)
        NOT_MEMBER = typing___cast(CheckResponse.MembershipValue, 1)
        MEMBER = typing___cast(CheckResponse.MembershipValue, 2)
    UNKNOWN = typing___cast(CheckResponse.MembershipValue, 0)
    NOT_MEMBER = typing___cast(CheckResponse.MembershipValue, 1)
    MEMBER = typing___cast(CheckResponse.MembershipValue, 2)

    is_member: builtin___bool = ...
    membership: type___CheckResponse.MembershipValue = ...
    ...
    def __init__(self,
        *,
        ...
        revision : typing___Optional[authzed___api___v0___core_pb2___Zookie] = None,
        membership : typing___Optional[type___CheckResponse.MembershipValue] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"revision",b"revision"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"is_member",b"is_member",u"membership",b"membership",u"revision",b"revision"]) -> None: ...
...
class ExpandResponse(google___protobuf___message___Message):
    ...
    @property
    def tree_node(self) -> authzed___api___v0___core_pb2___RelationTupleTreeNode: ...
    ...
    def __init__(self,
        *,
        tree_node : typing___Optional[authzed___api___v0___core_pb2___RelationTupleTreeNode] = None,
        revision : typing___Optional[authzed___api___v0___core_pb2___Zookie] = None,
        ) -> None: ...
...
class LookupRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    page_reference: typing___Text = ...
    limit: builtin___int = ...

    @property
    def object_relation(self) -> authzed___api___v0___core_pb2___RelationReference: ...

    @property
    def user(self) -> authzed___api___v0___core_pb2___ObjectAndRelation: ...
    ...
    def __init__(self,
        *,
        object_relation : typing___Optional[authzed___api___v0___core_pb2___RelationReference] = None,
        user : typing___Optional[authzed___api___v0___core_pb2___ObjectAndRelation] = None,
        at_revision : typing___Optional[authzed___api___v0___core_pb2___Zookie] = None,
        page_reference : typing___Optional[typing___Text] = None,
        limit : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"at_revision",b"at_revision",u"object_relation",b"object_relation",u"user",b"user"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"at_revision",b"at_revision",u"limit",b"limit",u"object_relation",b"object_relation",u"page_reference",b"page_reference",u"user",b"user"]) -> None: ...
type___LookupRequest = LookupRequest

class LookupResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    resolved_object_ids: google___protobuf___internal___containers___RepeatedScalarFieldContainer[typing___Text] = ...
    next_page_reference: typing___Text = ...
    ...
    def __init__(self,
        *,
        resolved_object_ids : typing___Optional[typing___Iterable[typing___Text]] = None,
        next_page_reference : typing___Optional[typing___Text] = None,
        revision : typing___Optional[authzed___api___v0___core_pb2___Zookie] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"revision",b"revision"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"next_page_reference",b"next_page_reference",u"resolved_object_ids",b"resolved_object_ids",u"revision",b"revision"]) -> None: ...
type___LookupResponse = LookupResponse
