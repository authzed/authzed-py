...
class RelationReference(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    namespace: typing___Text = ...
    relation: typing___Text = ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"namespace",b"namespace",u"relation",b"relation"]) -> None: ...
type___RelationReference = RelationReference
