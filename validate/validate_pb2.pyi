...
class FieldRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["any", b"any", "bool", b"bool", "bytes", b"bytes", "double", b"double", "duration", b"duration", "enum", b"enum", "fixed32", b"fixed32", "fixed64", b"fixed64", "float", b"float", "int32", b"int32", "int64", b"int64", "map", b"map", "message", b"message", "repeated", b"repeated", "sfixed32", b"sfixed32", "sfixed64", b"sfixed64", "sint32", b"sint32", "sint64", b"sint64", "string", b"string", "timestamp", b"timestamp", "type", b"type", "uint32", b"uint32", "uint64", b"uint64"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["any", b"any", "bool", b"bool", "bytes", b"bytes", "double", b"double", "duration", b"duration", "enum", b"enum", "fixed32", b"fixed32", "fixed64", b"fixed64", "float", b"float", "int32", b"int32", "int64", b"int64", "map", b"map", "message", b"message", "repeated", b"repeated", "sfixed32", b"sfixed32", "sfixed64", b"sfixed64", "sint32", b"sint32", "sint64", b"sint64", "string", b"string", "timestamp", b"timestamp", "type", b"type", "uint32", b"uint32", "uint64", b"uint64"]) -> None: ...
...
class FloatRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["const", b"const", "gt", b"gt", "gte", b"gte", "ignore_empty", b"ignore_empty", "lt", b"lt", "lte", b"lte"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["const", b"const", "gt", b"gt", "gte", b"gte", "ignore_empty", b"ignore_empty", "in", b"in", "lt", b"lt", "lte", b"lte", "not_in", b"not_in"]) -> None: ...
...
class BoolRules(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["const", b"const"]) -> None: ...
...
class StringRules(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["well_known", b"well_known"]) -> typing.Literal["email", "hostname", "ip", "ipv4", "ipv6", "uri", "uri_ref", "address", "uuid", "well_known_regex"] | None: ...
...
class BytesRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["const", b"const", "contains", b"contains", "ignore_empty", b"ignore_empty", "ip", b"ip", "ipv4", b"ipv4", "ipv6", b"ipv6", "len", b"len", "max_len", b"max_len", "min_len", b"min_len", "pattern", b"pattern", "prefix", b"prefix", "suffix", b"suffix", "well_known", b"well_known"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["const", b"const", "contains", b"contains", "ignore_empty", b"ignore_empty", "in", b"in", "ip", b"ip", "ipv4", b"ipv4", "ipv6", b"ipv6", "len", b"len", "max_len", b"max_len", "min_len", b"min_len", "not_in", b"not_in", "pattern", b"pattern", "prefix", b"prefix", "suffix", b"suffix", "well_known", b"well_known"]) -> None: ...
...
class EnumRules(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["const", b"const", "defined_only", b"defined_only", "in", b"in", "not_in", b"not_in"]) -> None: ...
...
class MessageRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["required", b"required", "skip", b"skip"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["required", b"required", "skip", b"skip"]) -> None: ...
...
class RepeatedRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["ignore_empty", b"ignore_empty", "items", b"items", "max_items", b"max_items", "min_items", b"min_items", "unique", b"unique"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ignore_empty", b"ignore_empty", "items", b"items", "max_items", b"max_items", "min_items", b"min_items", "unique", b"unique"]) -> None: ...
...
class MapRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["ignore_empty", b"ignore_empty", "keys", b"keys", "max_pairs", b"max_pairs", "min_pairs", b"min_pairs", "no_sparse", b"no_sparse", "values", b"values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ignore_empty", b"ignore_empty", "keys", b"keys", "max_pairs", b"max_pairs", "min_pairs", b"min_pairs", "no_sparse", b"no_sparse", "values", b"values"]) -> None: ...
...
class AnyRules(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["in", b"in", "not_in", b"not_in", "required", b"required"]) -> None: ...
...
class DurationRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["const", b"const", "gt", b"gt", "gte", b"gte", "lt", b"lt", "lte", b"lte", "required", b"required"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["const", b"const", "gt", b"gt", "gte", b"gte", "in", b"in", "lt", b"lt", "lte", b"lte", "not_in", b"not_in", "required", b"required"]) -> None: ...
...
class TimestampRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["const", b"const", "gt", b"gt", "gt_now", b"gt_now", "gte", b"gte", "lt", b"lt", "lt_now", b"lt_now", "lte", b"lte", "required", b"required", "within", b"within"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["const", b"const", "gt", b"gt", "gt_now", b"gt_now", "gte", b"gte", "lt", b"lt", "lt_now", b"lt_now", "lte", b"lte", "required", b"required", "within", b"within"]) -> None: ...
