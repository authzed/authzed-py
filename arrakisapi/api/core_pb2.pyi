...
class User(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"user_id",b"user_id",u"user_oneof",b"user_oneof",u"userset",b"userset"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"user_id",b"user_id",u"user_oneof",b"user_oneof",u"userset",b"userset"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"user_oneof",b"user_oneof"]) -> typing_extensions___Literal["user_id","userset"]: ...
type___User = User
