...
# source: arrakisapi/healthcheck/health_service.proto
...
HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), {
  ...
  '__module__' : 'arrakisapi.healthcheck.health_service_pb2'
